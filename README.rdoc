...
and may be updated, you should use dependent: :cascade. This will cascade both deletes and updates:
...
Finally, some adapters support :dependent :default, which affects the delete behaviour while still cascading updates.
